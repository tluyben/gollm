...
// Endpoint returns the API endpoint for OpenRouter
...
func (p *OpenRouterProvider) createBaseRequest(prompt string) map[string]interface{} {
...
func (p *OpenRouterProvider) processMessages(request map[string]interface{}) {
...
func (p *OpenRouterProvider) processFunctionMessage(msgMap map[string]interface{}) {
...
func (p *OpenRouterProvider) processToolCalls(msgMap map[string]interface{}) {
...
func (p *OpenRouterProvider) addOptions(request map[string]interface{}, options map[string]interface{}) {
	for k, v := range p.options {
		request[k] = v
	}
	for k, v := range options {
